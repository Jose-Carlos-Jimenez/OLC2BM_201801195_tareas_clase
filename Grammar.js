...
yy: {},
symbols_: {"error":2,"S":3,"E":4,"EOF":5,"+":6,"T":7,"-":8,"*":9,"F":10,"/":11,"(":12,")":13,"id":14,"number":15,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"+",8:"-",9:"*",11:"/",12:"(",13:")",14:"id",15:"number"},
...
switch (yystate) {
case 1:
 let result = app.traduct($$[$0-1]); return result 
break;
case 2:
 this.$ = app.node('+', $$[$0-2], $$[$0]) 
break;
...
rules: [/^(?:\s+)/,/^(?:[0-9]+(\.[0-9]+)?\b)/,/^(?:([a-zA-Z]|_)[a-zA-Z0-9_]*)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\()/,/^(?:\))/,/^(?:$)/,/^(?:.)/],
